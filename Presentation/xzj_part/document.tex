...
\begin{document}
	...
	\begin{frame}[c]\frametitle{Search algorithm}
		\begin{columns}
			...
			\end{itemize}
			\column{6cm}
			\only{\centering{{\includegraphics[width=6cm]{timg.jpg}<1>}}}
		\end{columns}
	\end{frame}
	\frame{\titlepage}
	\begin{frame}[c]\frametitle{Meet in the middle}
		\begin{columns}
			...
			\end{itemize}
			\column{6cm}
			\only{\centering{{\includegraphics[width=6cm]{pic0.png}<1-2>}}}
			\only{\centering{{\includegraphics[width=6cm]{pic1.png}<3>}}}
			\only{\centering{{\includegraphics[width=7cm]{pic2.png}<4>}}}
		\end{columns}
	\end{frame}
	\begin{frame}[c]\frametitle{Some other applications}
		\begin{columns}
			...
			\end{itemize}
			\column{7cm}
			\only{\centering{{\includegraphics[width=7cm]{bl.png}<2>}}}
		\end{columns}
	\end{frame}
