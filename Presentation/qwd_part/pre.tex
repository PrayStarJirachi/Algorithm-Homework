	...
	\begin{frame}[c]\frametitle{$Query(x)$ details}
		\begin{columns}
			...
			\end{itemize}
			\column{4cm}
			\only{\centering{{\includegraphics[width=4cm]{qwd_part/22.png}<1>}}}
			\only{\centering{{\includegraphics[width=4cm]{qwd_part/23.png}<2>}}}
			\only{\centering{{\includegraphics[width=4cm]{qwd_part/18.png}<3->}}}
		\end{columns}
	\end{frame}
