...
\usepackage{float}
\usepackage[body={18.39cm, 24.62cm}, centering, dvipdfm]{geometry}
...
\begin{document}
	...
	\exercise{4}
	\input{source/yjc/ex4-1.tex}
	\input{source/yzl/ex4-2.tex}

	\exercise{7}
	\input{source/yjc/ex7-1.tex}
	\input{source/yzl/ex7-2.tex}

	\exercise{8}
	\input{source/xzj/ex8.tex}

	\exercise{10}
	\input{source/xzj/ex10.tex}
\end{document}
