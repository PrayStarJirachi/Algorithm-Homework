...
\begin{document}
	\title{CS217 - Algorithm Design and Analyis\\Homework Assignment 5}
	\author{
		\begin{tabular}{rl}
	...
	\date{\today}
	\maketitle
	\section{Linear Programs and Farkas Lemma}
	\exercise{2}
	\input{source/yjc/ex2.tex}

	\exercise{6}
	\input{source/yzl/ex6.tex}

	\exercise{7}
	\input{source/qwdxzj/ex7.tex}
