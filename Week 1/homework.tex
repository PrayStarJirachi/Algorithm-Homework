...
\begin{document}
	\title{Algorithm Design and Analysis\\Homework Assignment 1}
	\author{
		\begin{tabular}{rl}
		    \textbf{Group Name:\,\,\,\,\,\,\,\,\,\,}& Static\\
		    \textbf{Group Members: }& Zhengjia Xu, JiaCheng Yang\\
	...
	\exercise{}
	\input{source/yzl/ex1.tex}

	\exercise{}
	\input{source/qwd/ex2.tex}

	\exercise{}
	\input{source/qwd/ex3.tex}

	\exercise{}
	\begin{enumerate}
		\input{source/xzj/content.tex}
	\end{enumerate}
	...
	\exercise{}
	\input{source/yzl/ex6.tex}

	\exercise{}
	\input{source/yjc/ex7.tex}
